      ...
      <form action="proses-krs.php" method="POST">
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            ...
            border-opacity-50" id="inputId" name="inputId"
              placeholder="ID tidak perlu diisi, akan ditentukan secara otomatis" <?php if ($id == '') {
                echo "disabled";
              }
              ; ?>>
          </div>
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            ...
            border border-secondary border-opacity-50" id="inputNpmMahasiswa" name="inputNpmMahasiswa"
