    ...
    <div class="container text-dark mt-5">
      <form method="POST" action="proses-mahasiswa.php">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <input required type="text" class="form-control bg-body-tertiary border border-secondary 
                border-opacity-50" id="inputNamaMhs" name="inputNamaMhs" placeholder="Masukkan Nama"
              value="<?php echo $nama ?>">
          </div>
        </div>
          ...
          <div class="col-sm-10">
            <select required class="form-select bg-body-tertiary border border-secondary 
              ...
              <option <?php if ($jurusan == 'Sistem Informasi') {
                echo "selected";
              } ?> value="Sistem Informasi"> Sistem
                Informasi </option>
              <option <?php if ($jurusan == 'Teknik Informatika') {
                echo "selected";
              } ?> value="Teknik Informatika">Teknik
                Informatika</option>
            </select>
          </div>
        </div>
