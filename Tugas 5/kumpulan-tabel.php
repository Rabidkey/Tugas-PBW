  ...
  <nav class="navbar bg-body-tertiary mb-5 shadow fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#" style="font-size : 1.1em;">
        <img src="img/Fasilkom.png" alt="logo" style="width: 2.3em; margin-right: 0.5em;">
      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-item">
          <a class="nav-link bg-secondary bg-gradient active ms-2 disabled" aria-current="page" href="#">Tabel Basis
            Data</a>
        </li>
      </ul>
    </div>
        ...
        while ($result = mysqli_fetch_assoc($sql_mahasiswa)) {
          ...
          <tr>
            ...
            <td>
              ...
              echo $result['npm']; ?>" onClick="return confirm('Apakah anda yakin ingin menghapus data tersebut?')"> <i
        ...
        while ($result = mysqli_fetch_assoc($sql_matakuliah)) {
          ...
          <tr>
            ...
            <td>
              ...
              echo $result['kodemk']; ?>" onClick="return confirm('Apakah anda yakin ingin menghapus data tersebut?')"><i
                  class="bi bi-trash"></i> </a>
            </td>
          </tr>
          <?php
        ...
        while ($result = mysqli_fetch_assoc($sql_krs)) {
          ...
          <tr>
            ...
            <td>
              ...
              echo $result['id']; ?>" onClick="return confirm('Apakah anda yakin ingin menghapus data tersebut?')"><i
                  class="bi bi-trash"></i> </a>
            </td>
          </tr>
          <?php
